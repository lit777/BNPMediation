...
=======
  Len.MCMC <- dim(obj0$save.state$randsave)[1]
>>>>>>> 64b6343479f5a32f504ee1391211a8a070c310e9
...
=======
  zz <- list(TMean=mean(Y1-Y0), TCI=c(sort(Y1-Y0)[Len.MCMC*0.025],sort(Y1-Y0)[Len.MCMC*0.975]))
>>>>>>> 64b6343479f5a32f504ee1391211a8a070c310e9
  return(c(z,zz))
}